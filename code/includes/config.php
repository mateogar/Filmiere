...
define('BD_NAME', 'filmiere_bd');
define('BD_USER', 'admin');
define('BD_PASS', 'adminPass');
define('RAIZ_APP', __DIR__);
define('RUTA_APP', '/pag/');
define('RUTA_IMGS', RUTA_APP.'img/');
define('RUTA_PDFS', RUTA_APP.'promos/');
define('RUTA_CSS', RUTA_APP.'css/');
define('RUTA_JS', RUTA_APP.'js/');
define('INSTALADA', true );

$EXTENSIONES_PERMITIDAS_IMAGEN = array('gif','jpg','jpe','jpeg','png');
$EXTENSIONES_PERMITIDAS_ARCHIVO = array('pdf');
